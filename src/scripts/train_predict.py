...
featfeature_all = ['cosine_similarity', 'max_score_in_position', 'overlap', 'soft_cosine_similarity', 'bert_cs',
...
if __name__ == '__main__':
    ...
    parser.add_argument("--test_set",
                        default="/content/apex/Headline-Stance-Detection/FNC_summy_textRank_test_spacy_pipeline_polarity_v2.json",
                        type=str,
...
if __name__ == '__main__':
    ...
    parser.add_argument("--training_set",
                        default="/content/apex/Headline-Stance-Detection/FNC_summy_textRank_train_spacy_pipeline_polarity_v2.json",
                        type=str,
                        help="This parameter is the relatis_type_contradictionive dir of training set.")
